<%@ Page Language="VB" AutoEventWireup="false" CodeFile="pardimregn.aspx.vb" Inherits="pardimregxn" %>
...
#listatt
{
	...
	<%  		    Dim ptype As String
	    ...
	    ptype = fm.getjavalist2("pardimpay", "distinct payreason", Session("con"), ",")
...
<% end if 
if  ptype<>"" then%>
var  ptype=[<% response.write( ptype) %>];
<%end if
%>
function checkdate(){
var d1;
...
<div style="width:100%; background:#6879aa; text-align:center;color:White; font-size:19pt;"> 
    Payment Registration<form name="frmlistout" action="pardimregn.aspx" method="post" style="font-size:12pt;">
