            ...
            For Each d As String In Directory.GetDirectories(loc)
                ...
                If arr.Length > 0 Then
                    ...
                    "<span style=' display:block'>"
                        ...
                        Dim fcx() As String
                        fcx = k.Split("&")
                        If fcx.Length > 0 Then
                            For i As Integer = 0 To fcx.Length - 1
                                nfile &= fcx(i)
                            Next
                            If fcx.Length > 1 Then
                                Rename(k, nfile)
                            End If
                        End If
                        Dim ff As String
               ...
               " <span><a href=" & Chr(34) & "javascript:delfile('" & ff & "','1st');" & Chr(34) & ">delete</a></span>&nbsp;&nbsp;&nbsp;<span>" & _
               "<a href=" & Chr(34) & root & "/" & fld(fld.Length - 1) & "/" & up.findfilename(k) & Chr(34) & " target='_black'>View</a></span>" & _
            "</span></div>" & _
            "<div style='width:15px; float:left;'>&nbsp;</div>"
                    Next
                    rtstr &= "</div>"
                End If
                rtstr &= "<div style='clear:both'>"
