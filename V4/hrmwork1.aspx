<%@ Page Language="VB" AutoEventWireup="false" CodeFile="hrmwork1.aspx.vb" Inherits="hrmwork1" %>
...
<% 
    ...
    "</td></tr></table></form>"
    Response.Write(formmake("byname", cont, 300, 100, "Search By Name"))
    ...
    Response.Write(formmake("bydep", cont, 300, 100, "Search By Department"))


    'Dim cont As String
    cont = "<form id='fromtorec' method='post' action=''>" & _
    "<table cellspacing='0px' cellpadding='0px'><tr><td>Date Between</td></tr><tr><td>" & _
    ...
    Response.Write(formmake("bydaterec", cont, 400, 100, "Search By Recruitment Date"))
...
<%
    ...
    Response.Write(formmake("byproj1", cont, 400, 100, "Search By Project date"))
...
<%
    cont = "<form id='proj' method='post' action=''>" & _
                                       ...
                                       "</td></tr><td>Select:<select id='active' name='active'><option value='y'>Active only</option><option value='n'>Not active</option><option value=''>all</option></select></td></tr></table></form>"
    Response.Write(formmake("byproj2", cont, 400, 100, "Search By Project"))
    ...
    cont = "<form id='frmqual' method='post' action=''>" & _
                                       ...
                                       "</td></tr><td>Select:<select id='active' name='active'><option value='y'>Active only</option><option value='n'>Not active</option><option value=''>all</option></select></td></tr></table></form>"
    Response.Write(formmake("byqual", cont, 300, 100, "Search By Qualification"))
    ...
    cont = "<form id='frmpost' method='post' action=''>" & _
                                       ...
                                       "</td></tr><td>Select:<select id='active' name='active'><option value='y'>Active only</option><option value='n'>Not active</option><option value=''>all</option></select></td></tr></table></form>"
    Response.Write(formmake("bypost", cont, 300, 100, "Search By Position"))

%>

 <a href="view_report1.aspx?val=all" target="frm_tar">View All</a>
