...
Pension Report
    <form name="frmlistout" action="" method="post" style="font-size:12pt;">
        ...
        <input type="hidden" name="projname" id="projname" value='<%=namelist %>' />
         ...
         <option value="pension">Pension</option>
                 <option value="chk">check list</option>
         </select>
         <input type="button" value="Go" id="firstform" name="firstform" onclick="javascript:subtax();" />
    </form>
    </div>
    ...
    <div id="pinta4"  style="display:none;width:100px; height:28px;background:url(images/blue_banner-760x147x.jpg)
           #224488;color:White;cursor:pointer;float:left;"
            onclick="javascirpt:printpen('print','Report_print','<% response.write(Session("company_name")) %>','<% response.write(Today.ToLongDateString) %>','printA4');">
   ...
   <% 
       ...
       End If
       If Request.Item("tax") = "pension" Then
