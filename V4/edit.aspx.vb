...
Partial Class _edit
    ...
    Function makeform(ByVal tblname)
        ...
        formx = "<form method='post' id='frm" & tblname & "' name='" & tblname & "'>"
        formx = formx & "<table>"
        For i = 0 To icount - 1
                ...
                If fileupload1.FileName <> "" Then
                    ...
                    If fileok And fsize Then
                        ...
                        Catch ex As Exception
                            MsgBox("File could not be uploaded." & ex.ToString)
                        End Try
                    ElseIf fileok = False Then
                        MsgBox("Cannot accept files of this type.")
                    ElseIf fsize = False Then
                        MsgBox("File size is morethan acceptable; max size=100kb")
                    End If
