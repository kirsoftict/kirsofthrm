<%@ Page Language="VB" AutoEventWireup="false" CodeFile="__payroll.aspx.vb" Inherits="xpayroll" %>
...
for(var i=0;i<trs.length;i++)
{
  ...
  $("#pay").css({width:'900px',height:'500px'});
   ...
   // alert(whr + fn.toString());
    $('#frmpay').attr("target","frm_tar");
      ...
      // alert(output);
      $('#nextpage').val(output);
       $('#frmpay').attr("action","payroll.aspx?first=1&month="+month+"&year="+year+"&projname=<%response.write(Request.Form("projname")) %>");
 ...
 <script type="text/javascript" language="javascript">
    ...
    printWin.document.write("<meta http-equiv='content-type' content='application/ms-excel' /><meta name='content-disposition' content='attachment; filename=payrol.xls' /><title>" + head + "</title></head>" + printFriendly.innerHTML );
...
<form id="exportexcel" name="exprtexcel" action="print.aspx?pagename=payrol(<% response.write(request.querystring("month") & "-" & request.querystring("year")) %>" method="post" target="_blank">
