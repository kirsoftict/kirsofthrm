<%@ Page Language="VB" AutoEventWireup="false" CodeFile="dataallview-copy.aspx.vb" Inherits="dataallviewcopy" %>
...
<%Dim sql As String = ""
    ...
    If dt.HasRows Then
        ...
        <div id="pimleftmenu" style="padding-top:-12px; font-size:10pt;">
                   <div id="heading" style='width:600px; text-align:center;'><img src="<% response.write( Application("logo")) %>" width="80" style="float:left;" /><span style="font-size:12pt;"><% Response.Write(Application("company_name"))%><br />
                   Employee Curriculum Vita(CV)</span>
                   </div>
           <div style="text-decoration:none;  padding-left:15px; font-size:12pt;"><img src="images/gif/arrow_right.gif" />Personal Information</div>
                               
                        <div id="personalinfo"  class="datadisplay">
                            <table style="width: 600px; font-size:10pt;">
                                <tr>  
                                <td style="width:80px;">
                                        ...
                                        <table style=" width:400px;">
                                           <tr>
                                                <td style="width: 424px">
                                                   <label style="font-weight:bold"> <span>Tin</span></label></td>
                                                <td style="width: 57px">
                                                    :</td>
                                        ...
                                        <table style="width: 600px;" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td rowspan="" style="width: 18px;">
                                                    :</td>
                                                <td id="fullname" rowspan="" style="width: 350px; font-weight:normal; text-decoration:none;">
                                                    </td>
                                                    <td width="100px">&nbsp;</td>
                                           ...
                                           <td width="100px">&nbsp;</td>
                                                <td width="150px">
                                                   <label style="font-weight:bold">Sex</label></td>
                                                <td style="width: 10px">
                                                    :</td>
                                                <td style="width: 80px">
                                                    <span id='sex'></span></td>
                                            ...
                                            <td width="100px">&nbsp;</td>
                                                <td style="width: 150px">
                                                    <label style="font-weight:bold">Marital status</label></td>
                                                <td style="width: 57px">
                                                    :</td>
                                                <td style="width: 150px">
                            ...
                            <table style="width: 419px; font-size:10pt;">
                                <tr>
                                    <td colspan="">
                                        <strong>
                               ...
                               <div style="text-decoration:none;  padding-left:15px; font-size:12pt;"><img src="images/gif/arrow_right.gif" />Work Experience</div>

                    
                        
                        <div id="workexp" style="width:600px; font-size:8pt;" >
                          <% 
        ...
        %>
                                          ...
                                          <div style="text-decoration:none;  padding-left:15px; font-size:12pt;"><img src="images/gif/arrow_right.gif" />Educational Background</div>
        ...
        %>
                                          ...
                                          <div style="text-decoration:none;  padding-left:15px; font-size:12pt;"><img src="images/gif/arrow_right.gif" />Skills</div>
        ...
        %>
                                                            ...
                                                            <div style="text-decoration:none;  padding-left:15px; font-size:12pt;"><img src="images/gif/arrow_right.gif" />Reference</div>
  ...
  <div style="text-decoration:none;  padding-left:15px; font-size:12pt;"><img src="images/gif/arrow_right.gif" />Employment History</div>
 ...
 <div style="text-decoration:none;  padding-left:15px; font-size:12pt;"><img src="images/gif/arrow_right.gif" />Salary and Payroll information</div>
                             ...
                             allw = dbs.getallow(emptid, session("con"))
                                 ...
                                 <table style=" width:750px;"><tr><th colspan="3"></th></tr>
                                        ...
                                        <%
                                            ...
                                            sqlx = "select id,date_paid,b_sal,b_e,talw,alw,ot,gross_earnings,txinco,tax,pen_e,pen_c,netp,ref from payrollx where emptid in(select id from emprec where emp_id='" & emp_id & "') and (ref_inc is null or ref_inc='0') order by id desc"
                                            row = mk.tableviewsalpaidx("Paid Salary Information", sqlx, "Pay Date,Basic Salary,Earnings,Taxable Allowance,Allowance,OT,Gross Earning,Taxable income,Tax,Pension Contribution,Pension C.co.,Net Pay,Payroll Ref.", Session("con"), "")
                                         
                                            Response.Write(row & "<br>")
                                            sqlx = "select id,date_paid,b_sal,b_e,talw,alw,ot,gross_earnings,txinco,tax,pen_e,pen_c,netp,ref from payrollx where emptid in(select id from emprec where emp_id='" & emp_id & "') and (ref_inc is Not null and ref_inc<>'0') order by id desc"
                                            row = mk.tableviewsalpaidx("Paid Salary Information", sqlx, "Pay Date,Basic Salary,Earnings,Taxable Allowance,Allowance,OT,Gross Earning,Taxable income,Tax,Pension Contribution,Pension C.co.,Net Pay,Payroll Ref.", Session("con"), "")
 ...
 <div style="text-decoration:none;  padding-left:15px; font-size:12pt;"><img src="images/gif/arrow_right.gif" />Loan Information</div>
        ...
        %>
                      ...
                      <div style="text-decoration:none;  padding-left:15px; font-size:12pt;"><img src="images/gif/arrow_right.gif" />Leave Information</div>
        ...
        %>
              ...
              <div style="text-decoration:none;  padding-left:15px; font-size:12pt;"><img src="images/gif/arrow_right.gif" />Perdiem and Perdiem Paid</div>
        ...
        <div style="clear:both; "></div>
         ...
         <%               Dim outp As String = "<div id=" & Chr(34) & "print" & Chr(34) & " style=" & Chr(34) & " float:right; width:59px; height:33px; color:blue;cursor:pointer" & Chr(34) & " onclick=" & Chr(34) & "javascirpt:print('pimleftmenu','Report_print','" & Session("company_name") & "<BR> Personal Details','" & Today.ToLongDateString & "');" & Chr(34) & "><img src='images/ico/print.ico'/>print</div>"
             Response.Write(outp)
