<%@ Page Language="VB" AutoEventWireup="false" CodeFile="pardimpayform.aspx.vb" Inherits="pardimpayform" %>
...
if(confirm("Data is going to save, are you sure")){
   // $("#nextpage").val(output);
      ...
      $('#' +frm).submit();
      setTimeout(function(){location.reload(confirm('oh!!!!!!!!!!!'));},2000);
       }
...
<iframe id="payfrm" name="payfrm" src="" width='auto' height='auto' style=' visibility:hidden; top:0px; left:0px; position:absolute;'></iframe>
