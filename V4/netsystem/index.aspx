...
<html>
  <head>
  <%
   ' Session("conx") = System.Configuration.ConfigurationManager.ConnectionStrings("contractcon").ToString ' "Data Source=.\SQLEXPRESS;AttachDbFilename=" & Session("path") & "\netsystem\app_data\hrmp.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
...
var useruser="<%=session("emp_iid") %>";
var dtime=new Date();
//dtime=dtime.setDate(dtime.;

var rdate=new Date(dtime.getTime() + parseInt(timeout)*60000);
var datediff=rdate.getTime-dtime.getTime;
var rsmain=datediff.getMinutes;
  ...
  // alert(dtnow);
            if(rdate.getTime()<dtnow.getTime())
            {
...
<body>
    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="index.aspx"><img class="main-logo" src="<%=session("logo") %>" alt="" /></a>
                <strong><a href="index.aspx"><img src="<%=session("logo") %>" alt=""  /></a></strong>
            </div>
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li class="active">
                            <a class="has-arrow" href="index.html" aria-expanded="false"><span class="educate-icon educate-event icon-wrap"></span> <span class="mini-click-non">schedule</span></a>
                   
                         <ul class="submenu-angle" aria-expanded="true">
                                <li><a title="Dashboard v.1" href="index.html"><span class="mini-sub-pro">View all</span></a></li>
                                <li><a title="Dashboard v.2" href="index-1.html"><span class="mini-sub-pro">Add New</span></a></li>
                                <li><a title="Dashboard v.3" href="index-2.html"><span class="mini-sub-pro">show list</span></a></li>
                        ...
                        <li>
                            <a class="has-arrow" href="all-courses.html" aria-expanded="false"><span class="educate-icon educate-event icon-wrap"></span> <span class="mini-click-non">Departments</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="logo-pro">
                        <a href="index.aspx"><img class="main-logo" src="<%=session("logo") %>" alt="" style="height:50px;"/></a>
                    </div>
                </div>
            </div>
        </div>
                                        ...
                                        <div class="header-right-info">
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                <li class="nav-item dropdown">
                                                    <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="educate-icon educate-message edu-chat-pro" aria-hidden="true"></i><span class="">5</span></a>
                                                ...
                                                <li class="nav-item">
                                                    <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
															<img src="http://<%=session("imglink") %>" alt="" />
                                                    ...
                                                    <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                        ...
                                                        <li><a href="logout.aspx"><span class="edu-icon edu-locked author-log-ic"></span>Log Out</a>
                                                        </li>
                                                    </ul>
                                                </li>
    ...
    <script src="employee/Admin/kirubel/js/schedule.js"></script>
    <!-- plugins JS
		============================================ -->
