...
"ORDER BY emp_static_info.first_name", Session("con"))
        ...
        'line 2
        outp &= " <tr>"
        outp &= " <td colspan='13'  class='headerp'><center><strong>Perdiem Settlement    Form</strong></center></td>"
        outp &= "  </tr>" & Chr(13)
        'line3
        ...
        Dim rtp() As String
        rtp = fm.getproj_on_date(emptid, prdd.AddDays(Date.DaysInMonth(prdd.Year, prdd.Month)), Session("con"))
        outp &= "  <td colspan='2'>" & _
        rtp(1) & "</td>"
        outp &= " <td colspan='9'>&nbsp;</td></tr>" & Chr(13)
        'line 8
        ...
        outp &= "<table cellspacing='0' cellpadding='0'>"
        outp &= "<tr>"
        outp &= "<td style='width:100px;text-align:center;' colspan='2'>____________</td>"
        ...
        outp &= "<td style='width:100px;text-align:center;' colspan='2'> Receiver's <br>Signature</td>"

        outp &= "<td style='width:100px;text-align:center;'  colspan='2'>Prepared&nbsp; By</td>"

        outp &= "<td style='width:100px;text-align:center;' colspan='2'>Checked By</td>"

        outp &= "<td style='width:100px;text-align:center;' colspan='2'>Verified By</td>"

        outp &= "<td style='width:100px;text-align:center;' colspan='2'>Approved By</td>"
        outp &= " </tr>" & Chr(13)
        outp &= "<tr>"
        outp &= " <td colspan=" & Chr(34) & "13" & Chr(34) & ">&nbsp;</td>"
        outp &= "</tr>" & Chr(13)
        ...
        outp &= "</tr>" & Chr(13)
        outp &= " <tr>"
        outp &= "<td style='width:100px;text-align:center;' colspan='2'> Date</td>"
