...
Partial Class xpayroll
    ...
    Public Function makeform()
        ...
        If Request.Form("month") <> "" Then
            ...
            If rs.HasRows Then
                outp = "<table id='tb1' cellspacing='0' cellpadding='3' style='width:1300px;margin-left:55px;font-size:9pt;' border='0'>" & Chr(13)
                ...
                While rs.Read
                    ...
                    If ((resing >= pdate1 And resing <= pdate2) Or resing = "#1/1/1900#" Or pdate1 < resing) And incwhen = 0 Then 'question..........solved
                        ...
                        If cell(2).ToString <> "0" And cell(3) <> "0" Then
                            outp &= "<tr><td class='cell' id='" & emptid & "_0-" & k.ToString & "'>" & k.ToString & Chr(13)
    ...
    Function signpart()
        Dim outp As String = ""
        outp &= "<tr><td style='height:50px' colspan='15' style='width:100px;text-align:center;border:1px 1px 1px 1px white solid;'>&nbsp;</td></tr>"
        outp &= "<tr style='border:0px 0px 0px 0px;'>"
        outp &= "<td colspan='3' style='width:100px;text-align:center;border:1px 1px 1px 1px white solid;'>________________</td>"
        ...
        outp &= "<td  colspan='3' style='width:100px;text-align:center;border:1px 1px 1px 1px white solid;'> Receiver's Signature</td>"

        outp &= "<td colspan='3' style='width:100px;text-align:center;border:1px 1px 1px 1px white solid;'>Prepared&nbsp; By</td>"

        outp &= "<td colspan='3' style='width:100px;text-align:center;border:1px 1px 1px 1px white solid;'>Checked By</td>"

        outp &= "<td colspan='3' style='width:100px;text-align:center;border:1px 1px 1px 1px white solid;'>Verified By</td>"

        outp &= "<td colspan='3' style='width:100px;text-align:center;border:1px 1px 1px 1px white solid;'>Approved By</td>"
        outp &= " </tr>" & Chr(13)
        outp &= "<tr style='border:0px 0px 0px 0px;'><td style='height:50px' colspan='15' style='width:100px;text-align:center;border:1px 1px 1px 1px white solid;'>&nbsp;</td></tr>" & Chr(13)
        ...
        outp &= "</tr>" & Chr(13)
        outp &= " <tr>"
        outp &= "<td colspan='3' style='width:100px;text-align:center;border:1px 1px 1px 1px white solid;'> Date</td>"
